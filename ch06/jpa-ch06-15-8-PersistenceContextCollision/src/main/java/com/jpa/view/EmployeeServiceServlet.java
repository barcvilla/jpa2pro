 ...
 * @author PC
 */
@WebServlet(name="EmployeeServiceServlet", urlPatterns="/EmployeeServiceServlet")
public class EmployeeServiceServlet extends HttpServlet {

    private final String TITLE = 
        "Chapter 6: Extended Persistence Context Collision";
    
    private final String DESCRIPTION = 
        "This example shows the basic use of an extended persistence " +
        "context and its propagation adn Collision.";
